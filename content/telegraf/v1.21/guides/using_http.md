...
For the following example to work, configure [`influxdb` output plugin](/{{< latest "telegraf" >}}/plugins/##influxdb_v1.x). This plugin is what allows Telegraf to write the metrics to your InfluxDB.
